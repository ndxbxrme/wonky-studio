...
import {ConversationsCtrl} from './components/conversations.ctrl.js';
import conversationsTemplate from './components/conversations.html?raw';
import {ConversationEditorCtrl} from './components/conversation-editor.ctrl.js';
import conversationEditorTemplate from './components/conversation-editor.html?raw';
...
const initRoutes = async (app) => {
  ...
  app.template('conversations', conversationsTemplate);
  app.controller('conversations', ConversationsCtrl(app));
  app.template('conversation', conversationEditorTemplate);
  app.controller('conversation', ConversationEditorCtrl(app));
