...
import {VariablesCtrl} from './components/variables.ctrl.js';
import variablesTemplate from './components/variables.html?raw';
import {CharactersCtrl} from './components/characters.ctrl.js';
import charactersTemplate from './components/characters.html?raw';
import {CharacterEditorCtrl} from './components/character-editor.ctrl.js';
import characterEditorTemplate from './components/character-editor.html?raw';
...
import {ArtistGuideCtrl} from './components/artist-guide.ctrl.js';
import artistGuideTemplate from './components/artist-guide.html?raw';
...
const initRoutes = async (app) => {
  ...
  app.template('variables', variablesTemplate);
  app.controller('variables', VariablesCtrl(app));
  app.template('characters', charactersTemplate);
  app.controller('characters', CharactersCtrl(app));
  app.template('character', characterEditorTemplate);
  app.controller('character', CharacterEditorCtrl(app));
  ...
  app.template('artist-guide', artistGuideTemplate);
  app.controller('artist-guide', ArtistGuideCtrl(app));
